package com.cesarferracin.springProject.controller;
...
import com.cesarferracin.springProject.repository.PapelRepository;
...
public class UsuarioController {
	...
	//@CurrentSecurityContext - anotação para pegar o contexto da aplicação
	@GetMapping("/index")
	...
	public String salvarUsuario(@Valid Usuario usuario, BindingResult result, 
		...
		//Criptografa a senha passada pelo usuário no formulário
